import { AlertTriangle, Beaker, Check, Leaf, ThermometerSun } from 'lucide-react'; 
import {
  BarChart,
  Bar,
  XAxis,
  ...
  const recommendations = [
    {
      ...
      status: "warning",
      message: "Consider adding 5 kg/ha of nitrogen fertilizer for optimal growth",
      icon: AlertTriangle,
    },
    {
        ...
        <main className="flex-1">
          <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h1 className="text-2xl font-semibold text-gray-900">Soil Analysis Report</h1>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              {/* Nutrient Levels Chart */}
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h2 className="text-lg font-medium text-gray-900 mb-4">Nutrient Levels</h2>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Bar dataKey="recommended" name="Recommended" fill="#94A3B8" />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
              ...
              {/* pH Level History */}
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h2 className="text-lg font-medium text-gray-900 mb-4">pH Level History</h2>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart
                      data={phHistory}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h2 className="text-lg font-medium text-gray-900 mb-4">Organic Matter Content</h2>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                  ...
                  {recommendations.map((rec, index) => (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <rec.icon
                          className={`w-5 h-5 mt-0.5 ${rec.status === "warning" ? "text-amber-500" : "text-green-600"
                            }`}
                        />
                        <div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {nutrientLevels.map((nutrient, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                          {nutrient.recommended * 0.8} - {nutrient.recommended * 1.2} {nutrient.unit}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${Math.abs(nutrient.value - nutrient.recommended) <= nutrient.recommended * 0.2
                                ? "bg-green-100 text-green-800"
                                : "bg-amber-100 text-amber-800"
                              }`}
                          >
                            {Math.abs(nutrient.value - nutrient.recommended) <= nutrient.recommended * 0.2
                              ? "Optimal"
                              : "Needs Attention"}
                          </span>
                        </td>
